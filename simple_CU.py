...
def load_obj_ims():
	...
	objs_list=["enemy_boss4.png","enemy_boss3.png","enemy_boss.png","enemy_boss2.png","enemy_bb3.png","enemy_cv.png","enemy_bb.png",
	"enemy_dd6.png","enemy_bb5.png","enemy_dd7.png","enemy_bb4.png","question2.png","question1.png","enemy_bb6.png",
	"enemy_dd5.png","enemy_cv5.png","enemy_boss5.png",
	"enemy_cv2.png","enemy_dd.png","enemy_dd2.png","enemy_dd3.png","enemy_dd4.png","enemy_gold.png",
	"enemy_bb2.png","enemy_cv3.png","enemy_cv4.png"]
	labels_list=["chujiinmap.png","dahuoquansheng.png","zilv.png",
	"huodedaoju.png","queren.png","3-4.png","xingneng.png",
	"likeqianwang3.png","likeqianwang2.png","yingji.png","guibi.png","queding.png",
...
def simple_CU():
	if click_lab("enemy_boss4") or click_lab("enemy_boss3") or click_lab("enemy_boss") or click_lab("enemy_boss2"):return
	if exist("yingji")!=(-1,-1):
		if exist("guibi")!=(-1,-1):
...
def solve_boss_behind(alw_sleep=False):
	...
	if exist("enemy_boss5")!=(-1,-1):return
	if exist("yingji") and not moved:
		...
		if exist("enemy_boss5")!=(-1,-1) or exist("enemy_boss4")!=(-1,-1) or exist("enemy_boss3")!=(-1,-1) or exist("enemy_boss")!=(-1,-1) or exist("enemy_boss2")!=(-1,-1):return
		pos=(182,766)
...
def exist(lab,match_bound=0.8,vecdis_bound=500):
	...
	if np.max(result)>match_bound:
		...
		if dis<vecdis_bound : return pos
		else : return (-1,-1)
	else:
		return (-1,-1)
